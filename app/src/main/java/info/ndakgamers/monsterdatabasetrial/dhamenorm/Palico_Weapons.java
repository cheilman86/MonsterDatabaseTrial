...
public class Palico_Weapons {
    ...
    public Palico_Weapons() {
    }

    public Palico_Weapons(Integer _id, String setname, Integer defense, Integer vsfire, Integer vswater, Integer vsthunder, Integer vsice, Integer vsdragon) {
        this.m_Id = _id;
    ...
    public Palico_Weapons(Bundle b) {
        if (b != null) {
