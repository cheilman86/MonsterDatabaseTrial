...
public class Palico_Armor {
    ...
    public Palico_Armor(Integer _id, String setname, Integer defense, Integer vsfire, Integer vswater, Integer vsthunder, Integer vsice, Integer vsdragon) {
        this.m_Id = _id;
